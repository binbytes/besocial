  ...
  <div>
    <div
      ...
      <div
        ...
        class="flex justify-between py-2 px-6 border-b hover:bg-grey-lighter cursor-pointer">
        <div class="flex">
          <img
          ...
          <div class="ml-3">
            ...
            <span class="text-grey-dark font-light leading-normal text-sm">{{ conversation.last_message.body }}</span>
          </div>
        </div>
